...
export default async function Home() {
  return (
    <main
      ...
      className="flex min-h-screen flex-col pt-[4rem] items-start  lg:items-center justify-center"
    >
      <div className="max-w-7xl h-fit xl:px-0 px-[10%] items-start  lg:items-center lg:flex-row  flex-col flex justify-between mx-auto py-[2rem]">
